...
<body>
    <div class="container">
        <h1 class="text-center">Nurse Registration</h1>
        <form method="post">
            <div class="row">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result3->num_rows == 0) {
        ...
        $Nurse_Employee_ID = $con->insert_id;

        // Insert nurse data
        $sql4 = "INSERT INTO nurse (Nurse_Employee_ID, Certification)
             VALUES (?, ?)";
        $stmt4 = $con->prepare($sql4);
        $stmt4->bind_param("is", $Nurse_Employee_ID, $certification);
        $stmt4->execute();
